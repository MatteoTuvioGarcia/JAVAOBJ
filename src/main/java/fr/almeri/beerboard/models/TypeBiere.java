...
public class TypeBiere implements Serializable {
     ...
     * @param commentaire
     */
    public TypeBiere(Integer noType, String nomType, String description, String fermentation, String commentaire){
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TypeBiere)) return false;
        TypeBiere type = (TypeBiere) o;
